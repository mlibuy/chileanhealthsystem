---
title: "Emergency medicine physician impact in emergency department timeframes, the case of a Chilean hospital"
format: html
---
...
## Evaluating the Impact of Introducing an Ambulatory Process Coordinator on Emergency Department Throughput: A Regression Discontinuity Design
...
![RDD Model Equation](Screenshot%202025-06-25%20at%208.25.52%E2%80%AFPM.png)

#### Figure 1. Impact of an emergency physician on time from medical evaluation to discharge, RDD (±60-day window)

![RDD Plot](Screenshot%202025-06-25%20at%208.26.03%E2%80%AFPM.png)
